...
const skills = [
  ...
  { name: "PowerBI", icon: SiPowerbi, category: "Outils", color: "#F2C811" },
  {
    name: "Angular",
    icon: FaAngular,
    category: "Frameworks",
        ...
        <div className="flex flex-col md:flex-row items-start justify-between">
          ...
          >
            <p className="text-md text-gray-700 dark:text-gray-300 mb-4">
              Diplômé d&apos;un Master en informatique, spécialisé en génie
              logiciel, je conçois des applications performantes et élégantes,
              en alliant rigueur technique et créativité. J&apos;aime donner vie
              à des idées à travers des solutions concrètes, utiles et durables.{" "}
            </p>
            <p className="text-md text-gray-700 dark:text-gray-300 mb-4">
              Mon parcours s&apos;est enrichi d&apos;une double diplomation en
              management et gestion d&apos;entreprise, avec une spécialisation
              en gestion de projet. Cette complémentarité me permet de
              comprendre aussi bien les enjeux techniques que stratégiques, et
              de faire le lien entre vision, équipe et exécution.
            </p>
            <p className="text-md text-gray-700 dark:text-gray-300 mb-4">
              Ma passion pour l&apos;apprentissage continu et mon désir de
              rester à la pointe de la technologie me poussent à explorer
              constamment de nouvelles technologies et méthodologies.
            </p>
          </motion.div>
          <motion.div
            className="md:w-2/5"
